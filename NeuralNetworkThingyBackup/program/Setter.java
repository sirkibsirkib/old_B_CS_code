...
public class Setter {
	...
	private void askForDetail(){
		String choice = UIAuxiliaryMethods.askUserForChoice("Select a display mode",
				"Fast", "Intermediate", "Detailed");
		switch(choice){
		case "Fast":			displayDetail = 0;	progressIncrements = 400;	break;
		case "Intermediate":	displayDetail = 1;	progressIncrements = 200;	break;
		case "Detailed":		displayDetail = 2;	progressIncrements = 20;	break;
		default:				displayDetail = 0;	progressIncrements = 400;	break;
		}
	}
	
	private void askForNetworkRadius(){
		String choice = UIAuxiliaryMethods.askUserForChoice("Select neural stimulus template",
	...
	private void askForHiddenLayers(){
		String choice = UIAuxiliaryMethods.askUserForChoice("Enumerate the number of hidden layers",
	...
	private void adjustAndOfferSettings(){
		...
		case 0:	simsPerMinute = 7200/stimNodes*49;	break;
		case 1:	simsPerMinute = 2000/stimNodes*49;	break;
		case 2: simsPerMinute = 90/stimNodes*49;	break;
		}
		...
		while(!gMaxed || !iMaxed || !dMaxed){
			...
			if(weight < .45 && generations*depth < 250 && !gMaxed){
				g = (int)(g*1.1 + 1);
				lastToIncriment = "g";
			}
